module Hippo::Segments
  class CR2 < Base
    ...
    field   :name     => 'SubluxationLevelCode1',
            :datatype => :list,
            :list     => [ 'C1','C2','C3','C4','C5','C6','C7','CO','IL','L1','L2','L3','L4','L5','OC','SA','T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','T11','T12'],
            :required => false

    field   :name     => 'SubluxationLevelCode2',
            :datatype => :list,
            :list     => [ 'C1','C2','C3','C4','C5','C6','C7','CO','IL','L1','L2','L3','L4','L5','OC','SA','T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','T11','T12'],
            :required => false
