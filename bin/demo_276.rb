  ...
  def self.run
    ...
    ts.L2000D do |loop|
      ...
      loop.L2200D do |sub_loop|
        ...
        sub_loop.DTP do |seg|
          ...
          sub_loop.L2210D do |sub_loop_child|
            sub_loop_child.SVC do |composite_field|
              composite_field.CompositeMedicalProcedureIdentifier1 do |seg|
              ...
              composite_field.MonetaryAmount1 = ''
              composite_field.MonetaryAmount2 = ''
              composite_field.ProduceServiceId = ''
              composite_field.Quantity1 = ''
              
              composite_field.OriginalCompositeMedicalProcedureIdentifer1 do |seg|
      ...
      ts.L2000E do |loop|
        ...
        loop.L2200E do |sub_loop|
          ...
          sub_loop.L2210E do |sub_loop_child|
            sub_loop_child.SVC do |composite_field|
              composite_field.CompositeMedicalProcedureIdentifier1 do |seg|
                seg.CompositeMedicalProcedureIdentifier1 = ''
                seg.ProductServiceID = ''
                seg.ProcedureModifier1 = ''
                seg.ProcedureModifier2 = ''
                seg.ProcedureModifier3 = ''
      ...
      ts.SE do |seg|
        ...
        seg.TransactionSetControlerNumber = ''
      end
    end
  end